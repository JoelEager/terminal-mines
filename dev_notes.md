...
## AI Solver
Win rates:
| Difficulty | Optimal play | complex-solver | v2.1 | v2.0 | v1.5 |
| --- | --- | --- | --- | --- | --- |
| balanced | 90% | 90% | 90% | 87% | 78% |
| challenging | 80% | 81% | 80% | 73% | 55% |
| max | 65% | 62% | 60% | 52% | 19% |
| beginner | 92% | 91% | 91% | 86% | 77% |
| intermediate | 78% | 75% | 74% | 69% | 42% |
| expert | 40% | 31% | 28% | 18% | 1% |

(Measured over at least 3,000 iterations targeting a precision of +/- ~1%. Optimal play win rates from minesweeper.online.)

This branch has a worst case solve time approximately 130 times that of v2.1.
